...
export function fetchGpsCallback(setIsFetching:Function, setFetchStartTime:Function, setGpsInfo:Function) {
  setIsFetching(true);
...
export default function useGps(): [boolean, moment.Moment | undefined, PhaseSpace | undefined] {
  ...
  useEffect(() => {fetchGpsCallback(setIsFetching, setFetchStartTime, setGpsInfo)}, []);
